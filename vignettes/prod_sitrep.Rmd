...
#### Inset plots
- We can pre-filter the data and remove elements post-hoc to get an "inset" plot


```{r fig.width = 5, fig.height = 2}
inset_epi_curve <- df_who |>
  filter(date >= (sunday_date - weeks(10) + 1), date <= sunday_date) |>
  plot_epicurve(type = "cases", by_cat = "State Region", transparent = FALSE) +
  guides(fill = "none") +
  labs(title = "")
